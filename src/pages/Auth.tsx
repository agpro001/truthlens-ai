            ...
            <div className="space-y-3">
              ...
              >
                <svg className="w-5 h-5 fill-foreground" viewBox="0 0 24 24">
                  <path d="M17.05 20.28c-.98.95-2.05.8-3.08.38-1.09-.5-2.08-.48-3.24 0-1.44.62-2.2.44-3.06-.38C2.79 15.25 3.51 7.59 9.05 7.31c1.35.07 2.29.74 3.08.8.905-.04 1.77-.7 2.84-.73 1.85-.06 3.25.87 3.73 2.6-3.62 2.23-2.8 7.05.1 8.3z"/>
                </svg>
                Sign in with Apple
              </Button>
            </div>
